---
description: 'Instructions for composer-diff Go project'
...
**composer-diff** is a Go library module (module: `compdiff`) for comparing PHP Composer lock files. See README.md and SPECIFICATION.md for full details.
